(function() {
    ...
    "prototypes": [
        ...
        {
            "desc": "Логарифм от квадратного трёхчлена",
        ...
        {
            "desc": "Степень с квадратным показателем",
        ...
        {
            "desc": "Кубическая функция в разложенном виде",
        ...
        {
            "desc": "Квадратная функция с логарифмом",
        ...
        {
            "desc": "Косинус и линейная функция",
        ...
        {
            "desc": "Тангенс и линейная функция",
        ...
        {
            "desc": "Линейная и тригонометрическая функции",
        ...
        {
            "desc": "Линейная функция × экспонента",
        ...
        {
            "desc": "Квадратная функция × экспонента",
        ...
        {
            "desc": "Квадрат × экспонента на отрезке",
